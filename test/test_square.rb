...
class TestSquare < MiniTest::Test
  ...
  def test_moves
    @square=Chess::Square.new("a1")
    @square.add_piece(Chess::Bishop.new('a1'))
    values = ["b2", "c3", "d4", "e5", "f6", "g7", "h8", "i9", "b0", "c-1", "d-2", "e-3", "f-4", "g-5", "h-6", "i-7", "`2", "_3", "^4", "]5", "\\6", "[7", "Z8", "Y9", "`0", "_-1", "^-2", "]-3", "\\-4", "[-5", "Z-6", "Y-7", "a1"]
